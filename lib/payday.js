					...
					sockFunc.isShared(steamID, function(err_,isShared){
						...
						sockFunc.getSteamProfile(steamID, function(err__, profile){
							...
							try{
								...
								var primaryGun = primaryList[weaponIDs[getStat(payday, "equipped_primary").value-1]];
								var secondaryGun = secondaryList[weaponIDs[getStat(payday, "equipped_secondary").value-1]];
